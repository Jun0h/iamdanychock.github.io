...
const godotWindows = computed(() =>
  windowsStore.windows.filter((window) => window.ShowInGodotGrid !== false)
)
...
<div style="display: flex; align-items: center;">
    ...
    <p>Click on the icons to open the projects!</p>
      <nav class="grid-container1">
        <li class="grid-item1" v-for="window in godotWindows" :key="window.key">
          <button
            class="icon"
